...
describe('WishList e2e test', () => {
  ...
  it('should load WishLists', async () => {
    ...
    expect(await wishListComponentsPage.getTitle()).to.eq('jhipsterTestApp.wishList.home.title');
  ...
  it('should load create WishList page', async () => {
    ...
    expect(await wishListUpdatePage.getPageTitle()).to.eq('jhipsterTestApp.wishList.home.createOrEditLabel');
  ...
  it('should delete last WishList', async () => {
    ...
    expect(await wishListDeleteDialog.getDialogTitle()).to.eq('jhipsterTestApp.wishList.delete.question');
