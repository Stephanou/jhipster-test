...
export class SubCategoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.subCategoryService
      ...
      .subscribe(
        (res: HttpResponse<ISubCategory[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ISubCategory[] | null, headers: HttpHeaders, page: number): void {
